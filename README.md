...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,158 | 🐛 488 | 🌐 C++ | 📅 2026-08-22 - The definitive Open Source OCR engine `Apache 2.0`
...
* [doctr](https://github.com/mindee/doctr) ⭐ 6,309 | 🐛 22 | 🌐 Python | 📅 2026-08-21 - A seamless & high-performing OCR library powered by Deep Learning
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,562 | 🐛 97 | 🌐 Python | 📅 2026-08-22 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 76,158 | 🐛 488 | 🌐 C++ | 📅 2026-08-22 editor
