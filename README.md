...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,413 | 🐛 106 | 📅 2026-09-02
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,466 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 - The definitive Open Source OCR engine `Apache 2.0`
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,988 | 🐛 530 | 🌐 Python | 📅 2025-12-05 - OCR engine built on PyTorch by JaidedAI, `Apache 2.0`
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,727 | 🐛 99 | 🌐 Python | 📅 2026-09-08 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 76,466 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 editor
...
* [tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,693 | 🐛 50 | 🌐 JavaScript | 📅 2026-05-17 - Javascript port (emscripten) of Tesseract
