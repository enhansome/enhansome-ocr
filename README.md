...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,908 | 🐛 487 | 🌐 C++ | 📅 2026-08-13 - The definitive Open Source OCR engine `Apache 2.0`
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,905 | 🐛 530 | 🌐 Python | 📅 2025-12-05 - OCR engine built on PyTorch by JaidedAI, `Apache 2.0`
* [doctr](https://github.com/mindee/doctr) ⭐ 6,213 | 🐛 25 | 🌐 Python | 📅 2026-07-28 - A seamless & high-performing OCR library powered by Deep Learning
* [SwiftOCR](https://github.com/garnele007/SwiftOCR) ⭐ 4,633 | 🐛 86 | 🌐 Swift | 📅 2020-12-13 - fast and simple OCR library written in Swift
...
* [kraken](https://github.com/mittagessen/kraken) ⭐ 1,055 | 🐛 22 | 🌐 Python | 📅 2026-08-07 - Ocropus fork with sane defaults
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,431 | 🐛 98 | 🌐 Python | 📅 2026-08-06 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 75,908 | 🐛 487 | 🌐 C++ | 📅 2026-08-13 editor
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,981 | 🐛 73 | 🌐 C++ | 📅 2026-01-15 - gImageReader is a simple Gtk/Qt front-end to tesseract-ocr.
* [LAREX](https://github.com/chreul/larex) ⭐ 198 | 🐛 37 | 🌐 Java | 📅 2026-08-13 - A semi-automatic open-source tool for Layout Analysis and Region EXtraction on early printed books.
...
* [nw-page-editor](https://github.com/mauvilsa/nw-page-editor) ⭐ 32 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-11 - Simple app for visual editing of Page XML files. Provides desktop and [server docker-based](https://hub.docker.com/r/mauvilsa/nw-page-editor-web) versions.
...
* [OCR4all](https://github.com/OCR4all/OCR4all) ⭐ 709 | 🐛 26 | 🌐 Java | 📅 2024-02-05 - Provides OCR services through web applications. Included Projects: [LAREX](https://github.com/chreul/LAREX) ⭐ 198 | 🐛 37 | 🌐 Java | 📅 2026-08-13, [OCRopus](https://github.com/tmbdev/ocropy) ⚠️ Archived, [calamari](https://github.com/ChWick/calamari) ⭐ 1,198 | 🐛 66 | 🌐 Python | 📅 2026-06-23 and [nashi](https://github.com/andbue/nashi) ⭐ 17 | 🐛 2 | 🌐 HTML | 📅 2026-05-27.
...
* [kraken-docker](https://github.com/kba/kraken-docker) ⭐ 6 | 🐛 3 | 🌐 Makefile | 📅 2017-12-16 - Run the [kraken](https://github.com/mittagessen/kraken) ⭐ 1,055 | 🐛 22 | 🌐 Python | 📅 2026-08-07 OCR engine in a docker container
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 3,126 | 🐛 32 | 🌐 Go | 📅 2026-01-16 - Golang OCR library, wrapping Tesseract-ocr.
...
* [tesseract for .net](https://github.com/charlesw/tesseract) ⭐ 2,459 | 🐛 231 | 🌐 C# | 📅 2025-04-29 - A .Net wrapper for tesseract-ocr.
...
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,381 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - A Python wrapper for Google Tesseract.
* [tesserocr](https://github.com/sirfz/tesserocr) ⭐ 2,170 | 🐛 46 | 🌐 Python | 📅 2026-08-04 - A Python wrapper for the tesseract-ocr API
...
* [tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,624 | 🐛 46 | 🌐 JavaScript | 📅 2026-05-17 - Javascript port (emscripten) of Tesseract
* [ocrad.js](https://github.com/antimatter15/ocrad.js) ⭐ 3,519 | 🐛 28 | 🌐 JavaScript | 📅 2020-09-02 - Javascript port (emscripten) of ocrad
...
* [SwiftOCR](https://github.com/garnele007/SwiftOCR) ⭐ 4,633 | 🐛 86 | 🌐 Swift | 📅 2020-12-13 - Fast and simple OCR library written in Swift. Optimized for recognizing short, one line long alphanumeric codes.
* [Tesseract OCR iOS](https://github.com/gali8/Tesseract-OCR-iOS) ⭐ 4,222 | 🐛 120 | 🌐 C | 📅 2021-05-03 - Swift and Objective-C wrapper for Tesseract OCR.
...
* ["Needlessly complex" blog](https://mzucker.github.io/) (2016) [@mzucker](https://github.com/mzucker). Several image processing how-tos (Python based), particularly:
  * [Compressing and enhancing hand-written notes](https://mzucker.github.io/2016/09/20/noteshrink.html) ([code](https://github.com/mzucker/noteshrink) ⭐ 4,841 | 🐛 21 | 🌐 Python | 📅 2024-03-20)
...
* [cvOCR](https://github.com/Halfish/cvOCR) ⭐ 19 | 🐛 1 | 🌐 C++ | 📅 2016-10-28 - An OCR system for recognizing resume or cv text, implemented in Python and C and based on tesseract
...
* [Telugu OCR Framework using Deep Learning](https://arxiv.org/abs/1509.05962) (2015/2017) [Achanta](https://github.com/rakeshvar), Hastie
  * see also [TeluguOCR](https://github.com/TeluguOCR), [banti\_telugu\_ocr](https://github.com/TeluguOCR/banti_telugu_ocr) ⭐ 52 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-04-13, [chamanti\_ocr](https://github.com/rakeshvar/chamanti_ocr) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-08-25, [#49](https://github.com/kba/awesome-ocr/issues/49) ⭐ 3,118 | 🐛 64 | 📅 2024-07-06
