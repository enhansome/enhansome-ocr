...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,203 | 🐛 106 | 📅 2026-09-02
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,592 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 - The definitive Open Source OCR engine `Apache 2.0`
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,011 | 🐛 531 | 🌐 Python | 📅 2025-12-05 - OCR engine built on PyTorch by JaidedAI, `Apache 2.0`
* [doctr](https://github.com/mindee/doctr) ⭐ 6,358 | 🐛 28 | 🌐 Python | 📅 2026-09-15 - A seamless & high-performing OCR library powered by Deep Learning
...
* [Calamari](https://github.com/Calamari-OCR/calamari) ⭐ 1,200 | 🐛 66 | 🌐 Python | 📅 2026-06-23 - OCR Engine based on OCRopy and Kraken
...
* [kraken](https://github.com/mittagessen/kraken) ⭐ 1,070 | 🐛 24 | 🌐 Python | 📅 2026-09-04 - Ocropus fork with sane defaults
...
* [ocr-conversion-scripts](https://github.com/cneud/ocr-conversion-scripts) ⭐ 85 | 🐛 0 | 📅 2026-02-13
...
* [ALTO XML Schema](https://github.com/altoxml/schema) ⭐ 56 | 🐛 27 | 📅 2026-07-08 - XML Schema and development of the ALTO XML format
* [alto-tools](https://github.com/cneud/alto-tools) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Various tools to work with ALTO files, Python
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,814 | 🐛 91 | 🌐 Python | 📅 2026-09-16 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 76,592 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 editor
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,996 | 🐛 74 | 🌐 C++ | 📅 2026-01-15 - gImageReader is a simple Gtk/Qt front-end to tesseract-ocr.
* [LAREX](https://github.com/chreul/larex) ⭐ 199 | 🐛 38 | 🌐 Java | 📅 2026-09-19 - A semi-automatic open-source tool for Layout Analysis and Region EXtraction on early printed books.
...
* [PRImA PAGE Viewer](https://github.com/PRImA-Research-Lab/prima-page-viewer) ⭐ 37 | 🐛 10 | 🌐 HTML | 📅 2023-05-25 - Java based viewer for PAGE XML files (layout + text content). Also supports ALTO XML, FineReader XML, and HOCR.
...
* [binarize.c in ZBar](https://github.com/ZBar/ZBar/blob/master/zbar/qrcode/binarize.c) ⭐ 2,539 | 🐛 19 | 🌐 C | 📅 2024-03-18 - C implementations of two binarization algorithms, based on Sauvola
...
* [OCR4all](https://github.com/OCR4all/OCR4all) ⭐ 709 | 🐛 26 | 🌐 Java | 📅 2026-09-14 - Provides OCR services through web applications. Included Projects: [LAREX](https://github.com/chreul/LAREX) ⭐ 199 | 🐛 38 | 🌐 Java | 📅 2026-09-19, [OCRopus](https://github.com/tmbdev/ocropy) ⚠️ Archived, [calamari](https://github.com/ChWick/calamari) ⭐ 1,200 | 🐛 66 | 🌐 Python | 📅 2026-06-23 and [nashi](https://github.com/andbue/nashi) ⭐ 17 | 🐛 2 | 🌐 HTML | 📅 2026-05-27.
...
* [kraken-docker](https://github.com/kba/kraken-docker) ⭐ 6 | 🐛 3 | 🌐 Makefile | 📅 2017-12-16 - Run the [kraken](https://github.com/mittagessen/kraken) ⭐ 1,070 | 🐛 24 | 🌐 Python | 📅 2026-09-04 OCR engine in a docker container
...
* [ocrevalUAtion](https://github.com/impactcentre/ocrevalUAtion) ⭐ 68 | 🐛 9 | 🌐 HTML | 📅 2022-09-01 - Cross-format evaluation, CLI and GUI
...
* [gosseract](https://github.com/otiai10/gosseract) ⭐ 3,135 | 🐛 32 | 🌐 Go | 📅 2026-01-16 - Golang OCR library, wrapping Tesseract-ocr.
...
* [tesseract for .net](https://github.com/charlesw/tesseract) ⭐ 2,462 | 🐛 231 | 🌐 C# | 📅 2025-04-29 - A .Net wrapper for tesseract-ocr.

#### Object Pascal

* [TTesseractOCR4](https://github.com/r1me/TTesseractOCR4) ⭐ 152 | 🐛 6 | 🌐 Pascal | 📅 2023-07-13 - Object Pascal binding for tesseract-ocr 4.x.
...
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,390 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - A Python wrapper for Google Tesseract.
...
* [tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,719 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17 - Javascript port (emscripten) of Tesseract
* [ocrad.js](https://github.com/antimatter15/ocrad.js) ⭐ 3,516 | 🐛 28 | 🌐 JavaScript | 📅 2020-09-02 - Javascript port (emscripten) of ocrad
...
* [tesseract](https://github.com/ropensci/tesseract) ⭐ 251 | 🐛 17 | 🌐 R | 📅 2026-09-06 - R bindings for tesseract OCR.
...
* [ocrodeg](https://github.com/NVlabs/ocrodeg) ⭐ 165 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2020-05-18 - Document image degradation for OCR data augmentation
...
* ["Needlessly complex" blog](https://mzucker.github.io/) (2016) [@mzucker](https://github.com/mzucker). Several image processing how-tos (Python based), particularly:
  * [Compressing and enhancing hand-written notes](https://mzucker.github.io/2016/09/20/noteshrink.html) ([code](https://github.com/mzucker/noteshrink) ⭐ 4,844 | 🐛 21 | 🌐 Python | 📅 2024-03-20)
...
* [Telugu OCR Framework using Deep Learning](https://arxiv.org/abs/1509.05962) (2015/2017) [Achanta](https://github.com/rakeshvar), Hastie
  * see also [TeluguOCR](https://github.com/TeluguOCR), [banti\_telugu\_ocr](https://github.com/TeluguOCR/banti_telugu_ocr) ⭐ 52 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-04-13, [chamanti\_ocr](https://github.com/rakeshvar/chamanti_ocr) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-08-25, [#49](https://github.com/kba/awesome-ocr/issues/49) ⭐ 3,124 | 🐛 70 | 📅 2024-07-06
