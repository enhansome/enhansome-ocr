...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,609 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 - The definitive Open Source OCR engine `Apache 2.0`
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,016 | 🐛 531 | 🌐 Python | 📅 2025-12-05 - OCR engine built on PyTorch by JaidedAI, `Apache 2.0`
* [doctr](https://github.com/mindee/doctr) ⭐ 6,359 | 🐛 25 | 🌐 Python | 📅 2026-09-21 - A seamless & high-performing OCR library powered by Deep Learning
...
* [kraken](https://github.com/mittagessen/kraken) ⭐ 1,072 | 🐛 24 | 🌐 Python | 📅 2026-09-21 - Ocropus fork with sane defaults
...
* [ALTO XML Schema](https://github.com/altoxml/schema) ⭐ 56 | 🐛 28 | 📅 2026-07-08 - XML Schema and development of the ALTO XML format
* [alto-tools](https://github.com/cneud/alto-tools) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Various tools to work with ALTO files, Python
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,833 | 🐛 91 | 🌐 Python | 📅 2026-09-16 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 76,609 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 editor
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,997 | 🐛 74 | 🌐 C++ | 📅 2026-01-15 - gImageReader is a simple Gtk/Qt front-end to tesseract-ocr.
* [LAREX](https://github.com/chreul/larex) ⭐ 199 | 🐛 38 | 🌐 Java | 📅 2026-09-21 - A semi-automatic open-source tool for Layout Analysis and Region EXtraction on early printed books.
...
* [OCR4all](https://github.com/OCR4all/OCR4all) ⭐ 709 | 🐛 26 | 🌐 Java | 📅 2026-09-14 - Provides OCR services through web applications. Included Projects: [LAREX](https://github.com/chreul/LAREX) ⭐ 199 | 🐛 38 | 🌐 Java | 📅 2026-09-21, [OCRopus](https://github.com/tmbdev/ocropy) ⚠️ Archived, [calamari](https://github.com/ChWick/calamari) ⭐ 1,200 | 🐛 66 | 🌐 Python | 📅 2026-06-23 and [nashi](https://github.com/andbue/nashi) ⭐ 17 | 🐛 2 | 🌐 HTML | 📅 2026-05-27.
...
* [kraken-docker](https://github.com/kba/kraken-docker) ⭐ 6 | 🐛 3 | 🌐 Makefile | 📅 2017-12-16 - Run the [kraken](https://github.com/mittagessen/kraken) ⭐ 1,072 | 🐛 24 | 🌐 Python | 📅 2026-09-21 OCR engine in a docker container
...
* [tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,728 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17 - Javascript port (emscripten) of Tesseract
