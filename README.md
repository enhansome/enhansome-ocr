...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,181 | 🐛 487 | 🌐 C++ | 📅 2026-08-25 - The definitive Open Source OCR engine `Apache 2.0`
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,936 | 🐛 530 | 🌐 Python | 📅 2025-12-05 - OCR engine built on PyTorch by JaidedAI, `Apache 2.0`
* [doctr](https://github.com/mindee/doctr) ⭐ 6,312 | 🐛 22 | 🌐 Python | 📅 2026-08-21 - A seamless & high-performing OCR library powered by Deep Learning
...
* [kraken](https://github.com/mittagessen/kraken) ⭐ 1,059 | 🐛 19 | 🌐 Python | 📅 2026-08-21 - Ocropus fork with sane defaults
...
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,574 | 🐛 97 | 🌐 Python | 📅 2026-08-22 - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
...
* [VietOCR](http://vietocr.sourceforge.net/) - A Java/.NET GUI frontend for Tesseract OCR engine, including [jTessBoxEditor](http://vietocr.sourceforge.net/training.html) a graphical Tesseract [box data](https://github.com/tesseract-ocr/tesseract/wiki/Make-Box-Files) ⭐ 76,181 | 🐛 487 | 🌐 C++ | 📅 2026-08-25 editor
...
* [LAREX](https://github.com/chreul/larex) ⭐ 199 | 🐛 37 | 🌐 Java | 📅 2026-08-25 - A semi-automatic open-source tool for Layout Analysis and Region EXtraction on early printed books.
...
* [OCR4all](https://github.com/OCR4all/OCR4all) ⭐ 709 | 🐛 26 | 🌐 Java | 📅 2024-02-05 - Provides OCR services through web applications. Included Projects: [LAREX](https://github.com/chreul/LAREX) ⭐ 199 | 🐛 37 | 🌐 Java | 📅 2026-08-25, [OCRopus](https://github.com/tmbdev/ocropy) ⚠️ Archived, [calamari](https://github.com/ChWick/calamari) ⭐ 1,197 | 🐛 66 | 🌐 Python | 📅 2026-06-23 and [nashi](https://github.com/andbue/nashi) ⭐ 17 | 🐛 2 | 🌐 HTML | 📅 2026-05-27.
...
* [kraken-docker](https://github.com/kba/kraken-docker) ⭐ 6 | 🐛 3 | 🌐 Makefile | 📅 2017-12-16 - Run the [kraken](https://github.com/mittagessen/kraken) ⭐ 1,059 | 🐛 19 | 🌐 Python | 📅 2026-08-21 OCR engine in a docker container
...
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,383 | 🐛 21 | 🌐 Python | 📅 2026-07-13 - A Python wrapper for Google Tesseract.
...
* [tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,669 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-17 - Javascript port (emscripten) of Tesseract
